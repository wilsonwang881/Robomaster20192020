 ...
 *  V1.0.0     Dec-26-2018     RM              1. 完成 Completed
 *
 @verbatim
 ==============================================================================
 ==============================================================================
...
//左右的遥控器通道号码
//Number of left and right remote control channel
...
//the ratio that transform the rc to the moving speed on forward and backward
#define CHASSIS_VX_RC_SEN 0.006f
//遥控器左右摇杆（max 660）转化成车体左右速度（m/s）的比例
//the ratio that transform the rc to the moving speed on left and right
#define CHASSIS_VY_RC_SEN 0.005f
//跟随底盘yaw模式下，遥控器的yaw遥杆（max 660）增加到车体角度的比例
//the ratio that control the pitch of the chassis when the mode is following the yaw of chassis
...
//底盘任务控制间隔 0.002s
//chassis task control period in s
#define CHASSIS_CONTROL_TIME 0.002
//底盘任务控制频率，尚未使用这个宏
//chassis control frequency
#define CHASSIS_CONTROL_FREQUENCE 500.0f
//底盘3508最大can发送电流值
//maximum current of the CAN on 3508 chassis
#define MAX_MOTOR_CAN_CURRENT 16000.0f
//底盘摇摆按键
//key for chassis swing
#define SWING_KEY KEY_PRESSED_OFFSET_CTRL
//底盘前后左右控制按键
//keys for chassis moving forward, backward, left and right
...
//底盘运动过程最大平移速度
//maximum left/right shifting speed
