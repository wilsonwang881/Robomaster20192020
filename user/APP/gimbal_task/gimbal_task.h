...
//Current value during gimbal’s calibration, step time, and gyro limit
...
//Determine if there is signal input from the RC, and the no-control (motionless) time then set gimbal’s YAW value to the center to prevent the gyro from drifting 
